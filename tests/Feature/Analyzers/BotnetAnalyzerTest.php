...
it('updates database correctly when a cluster is detected', function () {
    ...
    VisitLog::factory()->create(['fingerprint_hash' => $hash, 'ip_address' => '2.2.2.2']);
    VisitLog::factory()->create(['fingerprint_hash' => $hash, 'ip_address' => '3.3.3.3']);
    ...
    expect($log1->is_bot)->toBeTrue()
        ...
        ->and($log1->bot_reasons)->toContain('botnet_cluster_match'); 
});
